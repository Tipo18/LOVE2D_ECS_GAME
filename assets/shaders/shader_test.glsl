...
// #define coulour_1 vec4(0.85,0.2,0.2,1.0)
// #define colour_3 vec4(0.0,0.0,0.0,1.0)

#define coulour_1 vec4(0.4,0.4,0.4,1.0)
...
vec4 ret_col = (0.3/contrast)*col1 + (1. - 0.3/contrast)*(col1*c1p + colour_2*c2p + vec4(c3p*colour_3.rgb, c3p*col1.a)) + 0.3*max(c1p*5. - 4., 0.) + 0.4*max(c2p*5. - 4., 0.);
